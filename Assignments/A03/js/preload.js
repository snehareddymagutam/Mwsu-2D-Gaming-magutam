var preload = {
	preload:function(){
		...
		this.load.image('ob', 'images/monster.png')
		this.load.image('obs', 'images/monster1.png')
		this.load.image('obst', 'images/monster2.png')
		this.load.image('obsta', 'images/obstacle.png')
		this.load.image('obstac', 'images/bomb.png')
