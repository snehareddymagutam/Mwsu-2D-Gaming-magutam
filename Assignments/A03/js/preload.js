var preload = {
	preload:function(){
		...
		this.load.image('ob', 'images/platform3.png')
		this.load.image('obs', 'images/platform1.png')
		this.load.image('obst', 'images/platform2.png')
		this.load.image('obsta', 'images/tile.png')
