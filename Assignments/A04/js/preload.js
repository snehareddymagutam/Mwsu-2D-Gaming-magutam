var preload = {
	preload:function(){
		...
		// Load all my new obstacles
		game.load.image('icon-blue', 'assets/icon-blue.png');
		game.load.image('icon-chicken', 'assets/icon-chicken.png');
		game.load.image('icon-green', 'assets/icon-green.png');
		game.load.image('icon-cookie', 'assets/icon-cookie.png');
		game.load.image('icon-minion', 'assets/icon-minion.png');
		game.load.image('icon-poop', 'assets/icon-poop.png');
		game.load.image('icon-toffee', 'assets/icon-toffee.png');
		...
		game.ufo.preLoad('ufoAtlas', 'assets/spaceship.png', 'assets/spcesp.json');

		game.load.spritesheet('kaboom', 'assets/explode.png', 45, 45);
		game.load.image('starfield', 'assets/starfield.png');

		// audio
		game.load.audio('bg_spin', 'sounds/spin_bg_music.mp3')
		game.load.audio('exp', 'sounds/explosion.mp3')
