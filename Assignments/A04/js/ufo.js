function Ufo(game_copy) {
    ...
    this.preLoad = function (atlas_name, sprite_sheet, atlas_json) {
        ...
        game.load.image('bullet', 'assets/image1.png')
    };

    this.create = function () {
        this.ship = game.add.sprite(game.width / 2, 250, this.atlasName);
        this.ship.animations.add('hover', Phaser.Animation.generateFrameNames('sprite', 1, 6), 20, true);
    ...
    this.fireBullets = function() {
        ...
        if (bullet) {
            ...
            bullet.reset(this.ship.x, this.ship.y+120);
