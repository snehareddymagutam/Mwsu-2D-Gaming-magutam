...
function Ufo1(game_copy) {
    ...
    this.preLoad = function (atlas_name='ufoAtlas1', sprite_sheet='assets/images/spaceship.png', atlas_json='assets/images/spcesp.json') {
    ...
    this.create = function (x, y, x_scale, y_scale) {
        ...
        this.ship.animations.add('hover', Phaser.Animation.generateFrameNames('sprite', 1, 4), 20, true);
