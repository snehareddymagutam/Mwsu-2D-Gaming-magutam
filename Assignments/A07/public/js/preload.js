var preload = {
	preload:function(){
		...
		game.load.spritesheet('shipexp', 'assets/images/explode.png', 45, 45);
		game.load.spritesheet('kaboom', 'assets/sprites/explode.png', 128, 128);
		game.load.spritesheet('button', 'assets/images/reticlesprite.png', 136, 135);
		...
		game.load.spritesheet('earth1', 'assets/images/whiteplanet.png', 85,85,48);
		game.load.spritesheet('earth2', 'assets/images/green_planet.png', 85,85,48);
		game.load.spritesheet('earth3', 'assets/images/orangeplanet.png', 85,85,48);
		game.load.spritesheet('earth4', 'assets/images/blueplanet.png', 85,85,48);
		game.load.atlas('ufoAtlas1','assets/images/spaceship.png','assets/images/spcesp.json');
